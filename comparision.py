...
#cat_data = df
#cat_ele = ['FLAG','Time Diff between first and last (Mins)','Received Tnx','Unique Received From Addresses','avg val received','min val sent','Total ERC20 tnxs','ERC20 total Ether received','ERC20 uniq rec contract addr']
#for i in df.columns:
#  if i not in cat_ele:
...
#print("=============================  CATBOOST DATASET  =============================")
#bin_set_cat = setup(cat_data, target = 'FLAG', session_id = 123)
#exp = ClassificationExperiment()
#exp.setup(cat_data, target = 'FLAG', session_id = 123)
